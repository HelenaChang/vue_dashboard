        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <li class="page-item" v-for="page in pagination.total_pages" :key="page" :class="{'active': pagination.current_page === page}">
                    <a class="page-link text-info" href="#" @click.prevent="getProducts(page)">{{page}}</a>
                </li>
        ...
        <div class="modal fade" id="delProductModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
                        <button class="btn btn-danger btn-sm py-2" @click="deleteProduct">確認刪除</button>
                    </div>
                </div>
            </div>
        </div>  
...
export default {
    ...
    methods: {
        ...
        openModal(isNew, item) { // show product modal
            if (isNew) {
                this.tempProduct = {};
                this.isNew = true;
            } else {
        ...
        deleteModal(item){ //show delete modal
            const vm = this;
